    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      <div className="bg-white rounded overflow-hidden shadow-md ">
        <div className="p-3 sm:px-6 sm:py-4 text-gray-700">
          ...
          <p>
            主に国土交通省、防衛省、海外政府機関向けのインフラシステムのプロジェクトを担当しています。(5年目)
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded overflow-hidden shadow-md ">
        <div className="p-3 sm:px-6 sm:py-4 text-gray-700">
          ...
          <p>
            フロントエンド、バックエンド、ハードウェア、ものづくりなど様々な技術領域を駆使して、システム・アプリの開発を行っています。
          </p>
          <p>
            業務委託のフルスタックエンジニアをご希望でありましたら、ご連絡いただけますと幸いです。
          </p>
        </div>
      </div>
    </div>
